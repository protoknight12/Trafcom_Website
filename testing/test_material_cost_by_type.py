...
bought and cut by the linear meter, same as rods.
...
# Sheets/profiles: genuine area (width * height / 1e6) * cost_per_m2.
...
assert _material_cost(1000, 500, profile) == 5.0, _material_cost(1000, 500, profile)
